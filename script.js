...
function onAddItemSubmit(e) {
  ...
  // Eliminar el elemento antiguo al actualizarlo
  if (isEditMode) {
  ...
  // Comprobar que el elemento que vamos a añadir no esté ya en la lista
...
function init() {
  ...
  cancelBtn.addEventListener("click", onClickCancelEdit);
